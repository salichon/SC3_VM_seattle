...
class Protocol(_object):
    ...
    __swig_getmethods__["ClientTypeToString"] = lambda x: _Communication.Protocol_ClientTypeToString
    if _newclass:ClientTypeToString = staticmethod(_Communication.Protocol_ClientTypeToString)
    __swig_getmethods__["ClientPriorityToString"] = lambda x: _Communication.Protocol_ClientPriorityToString
    if _newclass:ClientPriorityToString = staticmethod(_Communication.Protocol_ClientPriorityToString)
...
def Protocol_MsgTypeToString(*args):
  return _Communication.Protocol_MsgTypeToString(*args)
Protocol_MsgTypeToString = _Communication.Protocol_MsgTypeToString

def Protocol_ClientTypeToString(*args):
  return _Communication.Protocol_ClientTypeToString(*args)
Protocol_ClientTypeToString = _Communication.Protocol_ClientTypeToString

def Protocol_ClientPriorityToString(*args):
  return _Communication.Protocol_ClientPriorityToString(*args)
...
class SyncRequestMessage(Core.Message):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.SyncRequestMessage_ClassName
    if _newclass:ClassName = staticmethod(_Communication.SyncRequestMessage_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.SyncRequestMessage_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.SyncRequestMessage_TypeInfo)
    def className(self): return _Communication.SyncRequestMessage_className(self)
    def typeInfo(self): return _Communication.SyncRequestMessage_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.SyncRequestMessage_Cast
    if _newclass:Cast = staticmethod(_Communication.SyncRequestMessage_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.SyncRequestMessage_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.SyncRequestMessage_ConstCast)
    def serialize(self, *args): return _Communication.SyncRequestMessage_serialize(self, *args)
    def __init__(self, *args): 
        this = _Communication.new_SyncRequestMessage(*args)
        try: self.this.append(this)
        except: self.this = this
    def empty(self): return _Communication.SyncRequestMessage_empty(self)
    def ID(self): return _Communication.SyncRequestMessage_ID(self)
...
class SyncResponseMessage(Core.Message):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.SyncResponseMessage_ClassName
    if _newclass:ClassName = staticmethod(_Communication.SyncResponseMessage_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.SyncResponseMessage_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.SyncResponseMessage_TypeInfo)
    def className(self): return _Communication.SyncResponseMessage_className(self)
    def typeInfo(self): return _Communication.SyncResponseMessage_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.SyncResponseMessage_Cast
    if _newclass:Cast = staticmethod(_Communication.SyncResponseMessage_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.SyncResponseMessage_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.SyncResponseMessage_ConstCast)
    def serialize(self, *args): return _Communication.SyncResponseMessage_serialize(self, *args)
    def __init__(self, *args): 
        this = _Communication.new_SyncResponseMessage(*args)
        try: self.this.append(this)
        except: self.this = this
    def empty(self): return _Communication.SyncResponseMessage_empty(self)
    def ID(self): return _Communication.SyncResponseMessage_ID(self)
...
class ServiceRequestMessage(Core.Message):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.ServiceRequestMessage_ClassName
    if _newclass:ClassName = staticmethod(_Communication.ServiceRequestMessage_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.ServiceRequestMessage_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.ServiceRequestMessage_TypeInfo)
    def className(self): return _Communication.ServiceRequestMessage_className(self)
    def typeInfo(self): return _Communication.ServiceRequestMessage_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.ServiceRequestMessage_Cast
    if _newclass:Cast = staticmethod(_Communication.ServiceRequestMessage_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.ServiceRequestMessage_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.ServiceRequestMessage_ConstCast)
    def serialize(self, *args): return _Communication.ServiceRequestMessage_serialize(self, *args)
    def service(self): return _Communication.ServiceRequestMessage_service(self)
...
class ServiceProvideMessage(Core.Message):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.ServiceProvideMessage_ClassName
    if _newclass:ClassName = staticmethod(_Communication.ServiceProvideMessage_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.ServiceProvideMessage_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.ServiceProvideMessage_TypeInfo)
    def className(self): return _Communication.ServiceProvideMessage_className(self)
    def typeInfo(self): return _Communication.ServiceProvideMessage_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.ServiceProvideMessage_Cast
    if _newclass:Cast = staticmethod(_Communication.ServiceProvideMessage_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.ServiceProvideMessage_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.ServiceProvideMessage_ConstCast)
    def serialize(self, *args): return _Communication.ServiceProvideMessage_serialize(self, *args)
    def service(self): return _Communication.ServiceProvideMessage_service(self)
    def parameters(self): return _Communication.ServiceProvideMessage_parameters(self)
    def empty(self): return _Communication.ServiceProvideMessage_empty(self)
...
class DatabaseRequestMessage(ServiceRequestMessage):
    __swig_setmethods__ = {}
    for _s in [ServiceRequestMessage]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, DatabaseRequestMessage, name, value)
    __swig_getmethods__ = {}
    for _s in [ServiceRequestMessage]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, DatabaseRequestMessage, name)
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.DatabaseRequestMessage_ClassName
    if _newclass:ClassName = staticmethod(_Communication.DatabaseRequestMessage_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.DatabaseRequestMessage_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.DatabaseRequestMessage_TypeInfo)
    def className(self): return _Communication.DatabaseRequestMessage_className(self)
    def typeInfo(self): return _Communication.DatabaseRequestMessage_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.DatabaseRequestMessage_Cast
    if _newclass:Cast = staticmethod(_Communication.DatabaseRequestMessage_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.DatabaseRequestMessage_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.DatabaseRequestMessage_ConstCast)
    def __init__(self, *args): 
...
class DatabaseProvideMessage(ServiceProvideMessage):
    __swig_setmethods__ = {}
    for _s in [ServiceProvideMessage]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, DatabaseProvideMessage, name, value)
    __swig_getmethods__ = {}
    for _s in [ServiceProvideMessage]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, DatabaseProvideMessage, name)
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.DatabaseProvideMessage_ClassName
    if _newclass:ClassName = staticmethod(_Communication.DatabaseProvideMessage_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.DatabaseProvideMessage_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.DatabaseProvideMessage_TypeInfo)
    def className(self): return _Communication.DatabaseProvideMessage_className(self)
    def typeInfo(self): return _Communication.DatabaseProvideMessage_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.DatabaseProvideMessage_Cast
    if _newclass:Cast = staticmethod(_Communication.DatabaseProvideMessage_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.DatabaseProvideMessage_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.DatabaseProvideMessage_ConstCast)
    def __init__(self, *args): 
        this = _Communication.new_DatabaseProvideMessage(*args)
        try: self.this.append(this)
        except: self.this = this
    def database(self): return _Communication.DatabaseProvideMessage_database(self)
...
class NetworkMessage(Core.BaseObject):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.NetworkMessage_ClassName
    if _newclass:ClassName = staticmethod(_Communication.NetworkMessage_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.NetworkMessage_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.NetworkMessage_TypeInfo)
    def className(self): return _Communication.NetworkMessage_className(self)
    def typeInfo(self): return _Communication.NetworkMessage_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.NetworkMessage_Cast
    if _newclass:Cast = staticmethod(_Communication.NetworkMessage_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.NetworkMessage_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.NetworkMessage_ConstCast)
    def serialize(self, *args): return _Communication.NetworkMessage_serialize(self, *args)
    def __init__(self, *args): 
    ...
    __del__ = lambda self : None;
    def privateSenderGroup(self): return _Communication.NetworkMessage_privateSenderGroup(self)
    def setPrivateSenderGroup(self, *args): return _Communication.NetworkMessage_setPrivateSenderGroup(self, *args)
    def clientName(self): return _Communication.NetworkMessage_clientName(self)
    def hostname(self): return _Communication.NetworkMessage_hostname(self)
    def type(self): return _Communication.NetworkMessage_type(self)
    def setType(self, *args): return _Communication.NetworkMessage_setType(self, *args)
    def messageType(self): return _Communication.NetworkMessage_messageType(self)
    def setMessageType(self, *args): return _Communication.NetworkMessage_setMessageType(self, *args)
    def contentType(self): return _Communication.NetworkMessage_contentType(self)
    def setContentType(self, *args): return _Communication.NetworkMessage_setContentType(self, *args)
    def destination(self): return _Communication.NetworkMessage_destination(self)
    def setDestination(self, *args): return _Communication.NetworkMessage_setDestination(self, *args)
    def tag(self, *args): return _Communication.NetworkMessage_tag(self, *args)
    def tagged(self): return _Communication.NetworkMessage_tagged(self)
    def seqNum(self): return _Communication.NetworkMessage_seqNum(self)
    def timestamp(self): return _Communication.NetworkMessage_timestamp(self)
    def data(self): return _Communication.NetworkMessage_data(self)
    def dataSize(self): return _Communication.NetworkMessage_dataSize(self)
    def setData(self, *args): return _Communication.NetworkMessage_setData(self, *args)
    def setSize(self, *args): return _Communication.NetworkMessage_setSize(self, *args)
    def size(self): return _Communication.NetworkMessage_size(self)
    def read(self, *args): return _Communication.NetworkMessage_read(self, *args)
    def write(self, *args): return _Communication.NetworkMessage_write(self, *args)
    def copy(self): return _Communication.NetworkMessage_copy(self)
    __swig_getmethods__["Encode"] = lambda x: _Communication.NetworkMessage_Encode
    if _newclass:Encode = staticmethod(_Communication.NetworkMessage_Encode)
    def decode(self): return _Communication.NetworkMessage_decode(self)
...
def NetworkMessage_Encode(*args):
  return _Communication.NetworkMessage_Encode(*args)
NetworkMessage_Encode = _Communication.NetworkMessage_Encode

class ServiceMessage(NetworkMessage):
    __swig_setmethods__ = {}
    for _s in [NetworkMessage]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ServiceMessage, name, value)
    __swig_getmethods__ = {}
    for _s in [NetworkMessage]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ServiceMessage, name)
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.ServiceMessage_ClassName
    if _newclass:ClassName = staticmethod(_Communication.ServiceMessage_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.ServiceMessage_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.ServiceMessage_TypeInfo)
    def className(self): return _Communication.ServiceMessage_className(self)
    def typeInfo(self): return _Communication.ServiceMessage_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.ServiceMessage_Cast
    if _newclass:Cast = staticmethod(_Communication.ServiceMessage_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.ServiceMessage_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.ServiceMessage_ConstCast)
    def serialize(self, *args): return _Communication.ServiceMessage_serialize(self, *args)
    def __init__(self, *args): 
    ...
    __del__ = lambda self : None;
    def protocolVersion(self): return _Communication.ServiceMessage_protocolVersion(self)
    def setProtocolVersion(self, *args): return _Communication.ServiceMessage_setProtocolVersion(self, *args)
    def clientType(self): return _Communication.ServiceMessage_clientType(self)
    def setClientType(self, *args): return _Communication.ServiceMessage_setClientType(self, *args)
    def clientPriority(self): return _Communication.ServiceMessage_clientPriority(self)
    def setClientPriority(self, *args): return _Communication.ServiceMessage_setClientPriority(self, *args)
    def copy(self): return _Communication.ServiceMessage_copy(self)
    def archiveSeqNum(self): return _Communication.ServiceMessage_archiveSeqNum(self)
    def setArchiveSeqNum(self, *args): return _Communication.ServiceMessage_setArchiveSeqNum(self, *args)
    def archiveTimestamp(self): return _Communication.ServiceMessage_archiveTimestamp(self)
    def setArchiveTimestamp(self, *args): return _Communication.ServiceMessage_setArchiveTimestamp(self, *args)
    def setPassword(self, *args): return _Communication.ServiceMessage_setPassword(self, *args)
    def password(self): return _Communication.ServiceMessage_password(self)
    def setPeerGroup(self, *args): return _Communication.ServiceMessage_setPeerGroup(self, *args)
    def peerGroup(self): return _Communication.ServiceMessage_peerGroup(self)
...
class NetworkInterface(Core.BaseObject):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["ClassName"] = lambda x: _Communication.NetworkInterface_ClassName
    if _newclass:ClassName = staticmethod(_Communication.NetworkInterface_ClassName)
    __swig_getmethods__["TypeInfo"] = lambda x: _Communication.NetworkInterface_TypeInfo
    if _newclass:TypeInfo = staticmethod(_Communication.NetworkInterface_TypeInfo)
    def className(self): return _Communication.NetworkInterface_className(self)
    def typeInfo(self): return _Communication.NetworkInterface_typeInfo(self)
    __swig_getmethods__["Cast"] = lambda x: _Communication.NetworkInterface_Cast
    if _newclass:Cast = staticmethod(_Communication.NetworkInterface_Cast)
    __swig_getmethods__["ConstCast"] = lambda x: _Communication.NetworkInterface_ConstCast
    if _newclass:ConstCast = staticmethod(_Communication.NetworkInterface_ConstCast)
    __swig_destroy__ = _Communication.delete_NetworkInterface
    __del__ = lambda self : None;
    def connect(self, *args): return _Communication.NetworkInterface_connect(self, *args)
    def disconnect(self): return _Communication.NetworkInterface_disconnect(self)
    def receive(self, error = None): return _Communication.NetworkInterface_receive(self, error)
    def send(self, *args): return _Communication.NetworkInterface_send(self, *args)
    def subscribe(self, *args): return _Communication.NetworkInterface_subscribe(self, *args)
    def unsubscribe(self, *args): return _Communication.NetworkInterface_unsubscribe(self, *args)
    def poll(self, error = None): return _Communication.NetworkInterface_poll(self, error)
    def isConnected(self): return _Communication.NetworkInterface_isConnected(self)
    __swig_getmethods__["Create"] = lambda x: _Communication.NetworkInterface_Create
...
def NetworkInterface_Create(*args):
  return _Communication.NetworkInterface_Create(*args)
...
class SystemConnection(Core.BaseObject):
    ...
    __del__ = lambda self : None;
    def connect(self, *args): return _Communication.SystemConnection_connect(self, *args)
    def reconnect(self): return _Communication.SystemConnection_reconnect(self)
    def disconnect(self): return _Communication.SystemConnection_disconnect(self)
    def isConnected(self): return _Communication.SystemConnection_isConnected(self)
    def subscribe(self, *args): return _Communication.SystemConnection_subscribe(self, *args)
    def unsubscribe(self, *args): return _Communication.SystemConnection_unsubscribe(self, *args)
    def subscribeArchive(self, *args): return _Communication.SystemConnection_subscribeArchive(self, *args)
    def unsubscribeArchive(self, *args): return _Communication.SystemConnection_unsubscribeArchive(self, *args)
    def archiveRequest(self): return _Communication.SystemConnection_archiveRequest(self)
    def receive(self, blocking = True, error = None): return _Communication.SystemConnection_receive(self, blocking, error)
    def readNetworkMessage(self, blocking = True): return _Communication.SystemConnection_readNetworkMessage(self, blocking)
    def readLocalMessage(self): return _Communication.SystemConnection_readLocalMessage(self)
    def send(self, *args): return _Communication.SystemConnection_send(self, *args)
    def poll(self): return _Communication.SystemConnection_poll(self)
    def listen(self, *args): return _Communication.SystemConnection_listen(self, *args)
    def stopListening(self): return _Communication.SystemConnection_stopListening(self)
    def isListening(self): return _Communication.SystemConnection_isListening(self)
    def masterAddress(self): return _Communication.SystemConnection_masterAddress(self)
    def peerGroup(self): return _Communication.SystemConnection_peerGroup(self)
    def privateGroup(self): return _Communication.SystemConnection_privateGroup(self)
    def type(self): return _Communication.SystemConnection_type(self)
    def priority(self): return _Communication.SystemConnection_priority(self)
    def groupCount(self): return _Communication.SystemConnection_groupCount(self)
    def group(self, *args): return _Communication.SystemConnection_group(self, *args)
    def groups(self): return _Communication.SystemConnection_groups(self)
    def password(self): return _Communication.SystemConnection_password(self)
...
class EMessageEncodingNames(_object):
    ...
    __swig_getmethods__["name"] = lambda x: _Communication.EMessageEncodingNames_name
    if _newclass:name = staticmethod(_Communication.EMessageEncodingNames_name)
...
def EMessageEncodingNames_name(*args):
  return _Communication.EMessageEncodingNames_name(*args)
EMessageEncodingNames_name = _Communication.EMessageEncodingNames_name

class Connection(SystemConnection):
    __swig_setmethods__ = {}
    for _s in [SystemConnection]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Connection, name, value)
    __swig_getmethods__ = {}
    for _s in [SystemConnection]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    __del__ = lambda self : None;
    def setEncoding(self, *args): return _Communication.Connection_setEncoding(self, *args)
    def encoding(self): return _Communication.Connection_encoding(self)
    def readMessage(self, *args): return _Communication.Connection_readMessage(self, *args)
    def readQueuedMessage(self, *args): return _Communication.Connection_readQueuedMessage(self, *args)
    def send(self, *args): return _Communication.Connection_send(self, *args)
    __swig_getmethods__["Create"] = lambda x: _Communication.Connection_Create
    if _newclass:Create = staticmethod(_Communication.Connection_Create)
    def dispatch(self, *args): return _Communication.Connection_dispatch(self, *args)
    def transmittedBytes(self): return _Communication.Connection_transmittedBytes(self)
    def receivedBytes(self): return _Communication.Connection_receivedBytes(self)
